...
__conda_setup="$('/home/kendru/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/kendru/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/kendru/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/kendru/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
export PATH="$HOME/Documentos/scripts:/home/linuxbrew/.linuxbrew/bin:$HOME/.serverless/bin:$PATH"
